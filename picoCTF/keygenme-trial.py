...
print(hashlib.sha256(bUsername_trial).hexdigest()[4], end="")
print(hashlib.sha256(bUsername_trial).hexdigest()[5], end="")
print(hashlib.sha256(bUsername_trial).hexdigest()[3], end="")
print(hashlib.sha256(bUsername_trial).hexdigest()[6], end="")
print(hashlib.sha256(bUsername_trial).hexdigest()[2], end="")
print(hashlib.sha256(bUsername_trial).hexdigest()[7], end="")
print(hashlib.sha256(bUsername_trial).hexdigest()[1], end="")
...
hash_values = "54ef6292"
full_key = "picoCTF{1n_7h3_|<3y_of_54ef6292}"
